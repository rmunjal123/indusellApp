...
export class Tab2Page implements OnInit {
  ...
  constructor(private formbuilder: FormBuilder, private createlistings: CreatelistingService, private camera: Camera, private file: File, private webview: WebView,
    ...
    private ref: ChangeDetectorRef, private http: HttpClient, private transfer: FileTransfer, private filepath:FilePath, private authservice: AuthenticationService) { }
  ngOnInit() {
